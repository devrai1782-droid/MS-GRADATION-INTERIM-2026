...
// ═══════════════════════════════════════════════════════
const _SB_URL  = IS_TESTING
  ? "https://lvblkqwftuzbysjvzffm.supabase.co/rest/v1"   // 🧪 TESTING
  : "https://dgzdessdyrxhsbjxeahi.supabase.co/rest/v1";  // 🚀 PRODUCTION
const _SB_KEY  = IS_TESTING
  ? "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2YmxrcXdmdHV6YnlzanZ6ZmZtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkzNzM2NTQsImV4cCI6MjA5NDk0OTY1NH0.adUYN_2cf1URWkXTR2qIi3GgwEADuD7rgB-_G40IL1I"   // 🧪 TESTING — Supabase > Settings > API > anon key
  : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRnemRlc3NkeXJ4aHNianhlYWhpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQwMTg5MzksImV4cCI6MjA4OTU5NDkzOX0.I0_-cV_OEahHu7DtDwvfY1xhPyJRWwUmqdYsSiZJqaw";  // 🚀 PRODUCTION
...
// ══════════════════════════════════════════════════
//  🔧 ENVIRONMENT SWITCH (api-helper.js se sync karo)
...
const SUPABASE_KEY = IS_TESTING
  ? "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2YmxrcXdmdHV6YnlzanZ6ZmZtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkzNzM2NTQsImV4cCI6MjA5NDk0OTY1NH0.adUYN_2cf1URWkXTR2qIi3GgwEADuD7rgB-_G40IL1I"  // 🧪 TESTING anon key
  : "sb_publishable_qzNG3P7YBOQ-WwjAe8bIgw_mNMJKrcG";                                                  // 🚀 PRODUCTION
...
try {
  await supabaseClient.from('users').update({ password: newPass }).eq('userid', 'DPI');
...
try {
  await supabaseClient.from('users').update({ password: newPass }).eq('userid', userId);
